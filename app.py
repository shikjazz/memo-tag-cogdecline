...
st.markdown("**Verbal Description (Transcript):**  " + df.transcript.iloc[0])
...
# Transposed Features Table
df_t = df.set_index("filename").T
st.subheader("📐 Transposed Features Table")
st.table(df_t)
